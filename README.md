...
- **Dataset generation:** Datasets are automatically generated by dataset managers in `dataset/` directory. See the `dataset_factory.py` for the unified interface.
...
Dataset generation is handled automatically by the dataset managers in the `dataset/` directory:
- `dataset/gp_acquisition_dataset_manager.py`: Manages GP-based datasets
- `dataset/lr_acquisition_dataset_manager.py`: Manages logistic regression datasets
- `dataset/hpob_acquisition_dataset_manager.py`: Manages HPO-B datasets
- `dataset/cancer_dosage_acquisition_dataset_manager.py`: Manages cancer dosage datasets
...
## Datasets
- `dataset/`: Directory containing dataset implementations:
...
- `dataset/gp_acquisition_dataset_manager.py`: Manager for GP-based datasets.
- `dataset/lr_acquisition_dataset_manager.py`: Manager for logistic regression datasets.
- `dataset/hpob_acquisition_dataset_manager.py`: Manager for HPO-B datasets.
- `dataset/cancer_dosage_acquisition_dataset_manager.py`: Manager for cancer dosage datasets.
...
- Add a new dataset manager in `dataset/` (see `dataset/hpob_acquisition_dataset_manager.py` for an example)
